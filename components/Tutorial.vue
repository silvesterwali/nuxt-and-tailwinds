  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">Welcome to my project</h2>
        <p>With this project i just try to learn basic of tailwind css.</p>
      </div>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/silvesterwali" target="_blank"
          ...
          >
            ...
            /></svg
        ></a>
        <a href="https://twitter.com/silvesterwali" target="_blank"
          ><svg
